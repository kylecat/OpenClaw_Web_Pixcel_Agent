...
const DECORATIONS: Decoration[] = [
  ...
  // appliances along right wall (col 21)
...
export function createWorldState(): WorldState {
  ...
  // Bulletin board (5×3, hangs 1 tile into wall) occupies grid rows 0–1, cols 1–5
  // Dashboard (5×3, same hang) occupies grid rows 0–1, cols 9–13
