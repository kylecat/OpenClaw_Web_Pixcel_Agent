import type { Character, GridTile, Direction } from './sceneTypes'
import { findPath } from './pathfinding'

export const TILE_SIZE = 64       // CSS px per tile (= 16 source px x 4)
export const WALK_SPEED = 128     // px / sec  (= TILE_SIZE x 2 -> 2 tiles/sec)
