...
> 氣象站進階功能：站級觀測、級聯選單、農業指標

### 新功能

- **氣象站級聯下拉選單**：22 縣市 → ~100 CWA 觀測站二級選擇
- **站級觀測資料**：選擇特定氣象站後，即時觀測與趨勢資料切換為該站數據（stationId 查詢）
- **GPS 預設站自動選取**：後端從 `.env` GPS 座標解析最近氣象站，前端自動選取
- **氣象站資訊顯示**：Overview 左下角顯示站名 @ GPS 座標
- **農業氣象 Skill**：新增 `L2_farm-weather-station.md` 技能文件

### 修復

- 修正氣象站資訊顯示不匹配（GPS 定位大安站卻顯示陽明山）
- 修正選擇氣象站後觀測資料未切換的問題
